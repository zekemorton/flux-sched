...
test_expect_success HAVE_PARTIAL_OK 'capacity assertion: the same rabbit job can be re-allocated (no residual allocation)' '
...
test_expect_success HAVE_PARTIAL_OK 'the same jobspec can be resubmitted and reaches alloc (no residual allocation)' '
